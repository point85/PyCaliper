...
class TestBridgesCase(unittest.TestCase):   
    def testBridges(self):   
        ...
        q1 = Quantity(10.0, ft)
        q2 = q1.convert(m)
        self.assertAlmostEqual(q2.amount, 3.048, None, None, TestingUtils.DELTA6)
        ...
        q1 = Quantity(10.0, kg)
        q2 = q1.convert(lbm)
        self.assertAlmostEqual(q2.amount, 22.0462262185, None, None, TestingUtils.DELTA6)
        q3 = q2.convert(q1.uom)
        self.assertAlmostEqual(q3.amount, 10.0, None, None, TestingUtils.DELTA6)
        
        q1 = Quantity(212.0, fahrenheit)
        q2 = q1.convert(celsius)
        self.assertAlmostEqual(q2.amount, 100, None, None, TestingUtils.DELTA6)
        q3 = q2.convert(q1.uom)
        self.assertAlmostEqual(q3.amount, 212, None, None, TestingUtils.DELTA6)
        
        mm = msys.createProductUOM(UnitType.AREA, None, "name", "mxm", "", m, m)
        
        q1 = Quantity(10.0, mm)
        q2 = q1.convert(ft2)
        self.assertAlmostEqual(q2.amount, 107.639104167, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(m2)
        ...
        q2 = q1.convert(kPa)
        self.assertAlmostEqual(q2.amount, 68.94757280343134, None, None, TestingUtils.DELTA6)
        ...
        self.assertAlmostEqual(q2.amount, 0.009113444152814231, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(mhr)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, gal)
        q2 = q1.convert(litre)
        self.assertAlmostEqual(q2.amount, 37.8541178, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(gal)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, m3)
        q2 = q1.convert(ft3)
        self.assertAlmostEqual(q2.amount, 353.1466672398284, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(m3)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, N)
        q2 = q1.convert(lbf)
        self.assertAlmostEqual(q2.amount, 2.24809, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(N)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, ftlbf)
        q2 = q1.convert(Nm)
        self.assertAlmostEqual(q2.amount, 13.558179483314004, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(ftlbf)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, lbm)
        q2 = q1.convert(kg)
        self.assertAlmostEqual(q2.amount, 4.5359237, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(lbm)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q1 = Quantity(10.0, km)
        q2 = q1.convert(mi)
        self.assertAlmostEqual(q2.amount, 6.21371192237, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(km)
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)
        ...
        self.assertAlmostEqual(q2.amount, 393.7007874015748, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(msys.getUOM(Unit.METRE))
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q2 = q1.convert(msys.getUOM(Unit.FOOT))
        self.assertAlmostEqual(q2.amount, 32.80839895013123, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(msys.getUOM(Unit.METRE))
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)
        ...
        self.assertAlmostEqual(q2.amount, 15500.031000062, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(msys.getUOM(Unit.SQUARE_METRE))
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)

        q2 = q1.convert(msys.getUOM(Unit.SQUARE_FOOT))
        self.assertAlmostEqual(q2.amount, 107.6391041670972, None, None, TestingUtils.DELTA6)
        q2 = q2.convert(msys.getUOM(Unit.SQUARE_METRE))
        self.assertAlmostEqual(q2.amount, 10.0, None, None, TestingUtils.DELTA6)
        ...
        self.assertAlmostEqual(q2.amount, 2.641720523581484, None, None, TestingUtils.DELTA6)
        ...
        q3 = q1.multiply(q2)
        self.assertAlmostEqual(q3.amount, 4046.8564224, None, None, TestingUtils.DELTA6)
